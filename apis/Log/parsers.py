...
log_parser.add_argument('log_timestamp', required=True, type=lambda x: datetime.strptime(x,'%Y-%m-%d %H:%M:%S'), location=('application_log'), help= 'No timestamp provided for the log.')
